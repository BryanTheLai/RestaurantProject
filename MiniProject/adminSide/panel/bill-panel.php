            ...
            <div class="m-50">
                ...
                if (isset($_POST['search'])) {
                    if (!empty($_POST['search'])) {
                        ...
                        $sql = "SELECT * FROM Bills WHERE bill_id LIKE '%$search%' OR customer_name LIKE '%$search%'";
                    } else {
                ...
                if ($result = mysqli_query($link, $sql)) {
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>";
                            echo '<a href="../billsCrud/deleteBill.php?bill_id='. $row['bill_id'] .'" title="Delete Record" data-toggle="tooltip" onclick="return confirm(\'Are you sure you want to delete this bill?\')"><span class="fa fa-trash text-black"></span></a>';
                            echo "</td>";
                             echo "<td>";
