                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        $deleteSQL = "DELETE FROM reservations WHERE reservation_id = '" . $row['reservation_id'] . "';";
                                            echo '<a href="../menuCrud/deleteReservation.php?id='. $row['reservation_id'] .'" title="Delete Record" data-toggle="tooltip" onclick="return confirm(\'Are you sure you want to delete this item?\')"><span class="fa fa-trash text-black"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
