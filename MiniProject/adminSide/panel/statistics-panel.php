...
<?php
// Query to calculate card revenue
$cardQuery = "
    SELECT
...
// Query to calculate cash revenue
$cashQuery = "
    SELECT
...
function paymentMethodCharts() {
  ...
  const barChartOptions = {
    title: 'Revenue Generated by Payment Method (Bar Chart)',
    bars: 'vertical'
  };

  const donutChartOptions = {
    title: 'Revenue Percentage by Payment Method (Donut Chart)',
    pieHole: 0.4
  };
